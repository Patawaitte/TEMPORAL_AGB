...
# # # # # # MOSAIKall
listresult = ['elevmax', 'elevmin', 'ElevP05', 'ElevP10', 'ElevP20', 'ElevP25', 'ElevP30', 'ElevP90', 'ElevP99',
              'P_first_r_above2', 'P_first_r_above2', 'P_first_r_abovemean', 'All_r_above2_Total_first_r',
              'All_r_abovemean_Total_first_r', 'ElevL1', 'Elevskewness', 'P_all_r_above2', 'P_all_r_abovemean',
              'Return3countabove2']

for x in listresult:
  RESULT ="C:\\Lidar\\Output_2017_grid_08451\\MosaicMetric_08451\\"+x+".tif"

  clipmosaic = glob("C:\\Lidar\\Output_2017_grid_08451\\*"+x+'.tif')
  # files_string = " ".join(files_to_mosaic)
  #files_to_mosaic = glob('/home/beland/PycharmProjects/Data_biomass/BIOMASS/Zone03/*.tif')

  vrt = gdal.BuildVRT("C:\\Lidar\\merged.vrt", clipmosaic,  VRTNodata= '-99' )
  #gdal.Translate("/home/beland/PycharmProjects/Data_biomass/Mosaic_biomass/30m_NAD83_landsat/MOSAIC_zone3_30M_BIOMASS_.tif", vrt)
  gdal.Translate(RESULT, vrt)
